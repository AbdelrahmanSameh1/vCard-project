                        ...
                        <form action="edit" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="you can't change the name because of your subdomain" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="whatsapp" class="form-control" id="exampleInputPassword1" placeholder="Whatsapp">
                                </div>
