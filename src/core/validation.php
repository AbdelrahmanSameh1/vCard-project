...
class validation
{
    ...
    {
        // echo $this->value;
        // echo gettype($this->value);die;



        // if (is_int($this->value)) {    // we will use regex instead of this because regex is more accurate
        //     return true;
        // }
    ...
    public function string()
    {
        ...
        if (!preg_match($regex, $this->value)) {
            $this->errors[] = "input: $this->input must be sting";
        }
        return $this;
    }
